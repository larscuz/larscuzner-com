...
import { formatFileSize, getMediaLibrary } from "@/lib/media-library";
...
function PreviewCard({
  ...
  if (mediaType === "video") {
    return (
      <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden bg-[linear-gradient(135deg,#0f0f0f_0%,#060606_100%)] text-white/35">
        <span className="text-[0.72rem] uppercase tracking-[0.3em]">Video file</span>
      </div>
    );
  }
  ...
  if (mediaType === "audio") {
    return (
      <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden bg-[linear-gradient(135deg,#0f0f0f_0%,#060606_100%)] text-white/35">
        <span className="text-[0.72rem] uppercase tracking-[0.3em]">Audio file</span>
      </div>
    );
  }
  ...
  return (
    <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden bg-[linear-gradient(135deg,#0f0f0f_0%,#060606_100%)] text-white/35">
      <span className="text-[0.72rem] uppercase tracking-[0.3em]">Document</span>
    </div>
  );
}
      ...
      <section className="rounded-[2rem] border border-[color:var(--line)] bg-white/80 p-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-black/60">Showing the deduplicated originals first, with variant counts where applicable.</p>
          </div>
          <p className="text-xs uppercase tracking-[0.22em] text-black/45">Generated {library.generatedAt}</p>
        </div>
